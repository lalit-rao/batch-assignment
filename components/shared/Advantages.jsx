    ...
    return (
        <div className="hero-container-features mt-12">
            <div className="banner-main-features md:flex md:flex-row flex flex-col min-h-[140vh]">
                <div
                    className="banner-left-advantages md:max-w-[49%] md:mx-auto max-w-[90%] mx-auto md:max-h-[45%] my-auto justify-center">
                    <div>
                        <p className="text-[#FF5555] text-[18px] font-medium">Advantages</p>
                        <p className="text-black md:text-[48px] text-[28px] font-bold pb-4">Why Choose Uifry?</p>
                        <div className="flex flex-row gap-2 md:text-[28px] text-[20px] font-semibold mb-8 capitalize">
                            <Image src={bell} height={30} alt="star" className="bell"/> Clever Notifications
                        </div>
